...
On first launch you will be presented with a login screen. Use your configured credentials. Admin users have access to stock management and the end of day report.
